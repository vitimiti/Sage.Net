...
/// A 2D region.
/// </summary>
/// <param name="Low">The <see cref="Coord2D"/> representing the lower part of the region.</param>
/// <param name="High">The <see cref="Coord2D"/> representing the higher part of the region.</param>
/// <seealso cref="FRegion2D"/>
