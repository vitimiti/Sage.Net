...
/// <summary>A 2D region.</summary>
/// <param name="Lo">A <see cref="Coord2D"/> representing the low end of the region.</param>
/// <param name="Hi">A <see cref="Coord2D"/> representing the high end of the region.</param>
