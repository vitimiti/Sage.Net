...
/// <summary>The base exception for all INI-related exceptions.</summary>
public class IniException : SageException
{
    /// <summary>Initializes a new instance of the <see cref="IniException"/> class.</summary>
    public IniException() { }
