...
/// <summary>Base INI reader that supports loading one or multiple INI files and dispatching parsing to registered block parsers.</summary>
public partial class Ini : IDisposable
{
